...
func TestClusterDescribe_SASLPlain(t *testing.T) {
	t.Parallel()
...
func TestTopicCRUD_SASLPlain(t *testing.T) {
	t.Parallel()
...
func TestTopicProduceConsume_SASLPlain(t *testing.T) {
	t.Parallel()
...
func TestGroupList_SASLPlain(t *testing.T) {
	t.Parallel()
